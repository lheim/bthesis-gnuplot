...
set output '../plots/section5_v2/received.eps'
...
! epstopdf ../plots/section5_v2/received.eps
! rm ../plots/section5_v2/received.eps


#transmitted samples
set title 'transmitted'
set ylabel 'transmitted samples'
set output '../plots/section5_v2/transmitted.eps'
...
! epstopdf ../plots/section5_v2/transmitted.eps
! rm ../plots/section5_v2/transmitted.eps
...
set output '../plots/section5_v2/eth_tx.eps'
...
plot two_container_file1 using 1:33:34 with yerrorbars title 'Machine 1'ps 2, \
  ...
  ! epstopdf ../plots/section5_v2/eth_tx.eps
  ! rm ../plots/section5_v2/eth_tx.eps


#eth rx
set title 'ethernet received'
set ylabel 'ethernet received [Mbit/s]'
set output '../plots/section5_v2/eth_rx.eps'
...
! epstopdf ../plots/section5_v2/eth_rx.eps
! rm ../plots/section5_v2/eth_rx.eps
...
set output '../plots/section5_v2/dropped.eps'
...
! epstopdf ../plots/section5_v2/dropped.eps
! rm ../plots/section5_v2/dropped.eps
